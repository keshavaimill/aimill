# Welcome to your aimill project
...
Build the app with `npm run build` and deploy the `dist/` folder to any static host (Vercel, Netlify, Cloudflare Pages, or your own server). Configure your custom domain in your hosting provider’s dashboard.
