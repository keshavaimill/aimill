          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 py-20">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="animate-fadeInLeft">
                <div className="inline-flex items-center gap-2 px-3 py-2 sm:px-4 rounded-full glass border border-border/50 text-muted-foreground text-xs font-bold tracking-widest mb-6 uppercase hover:text-foreground hover:border-sky-500/50 transition-all">
                  MARKETING AI
                </div>
                <h1 className="text-3xl sm:text-4xl lg:text-[64px] font-extrabold leading-[1.1] text-white mb-6 sm:mb-8 tracking-tight">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-4 mb-8 sm:mb-12">
                  <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 glass rounded-full border border-border/50 hover:border-sky-500/50 transition-all">
                    <span className="w-2 h-2 shrink-0 rounded-full bg-sky-500" />
                    <span className="text-xs sm:text-sm font-semibold">80% faster execution</span>
                  </div>
                  <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 glass rounded-full border border-border/50 hover:border-sky-500/50 transition-all">
                    <span className="w-2 h-2 shrink-0 rounded-full bg-sky-500" />
                    <span className="text-xs sm:text-sm font-semibold">40% cost reduction</span>
                  </div>
                  <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 glass rounded-full border border-border/50 hover:border-sky-500/50 transition-all">
                    <span className="w-2 h-2 shrink-0 rounded-full bg-sky-500" />
                    <span className="text-xs sm:text-sm font-semibold">3x ROI improvement</span>
                  </div>
                </div>
                <Link 
                  to="/contact"
                  className="inline-flex items-center gap-2 h-12 px-6 text-base sm:h-14 sm:px-8 sm:text-lg font-semibold bg-gradient-to-br from-sky-700 via-sky-800 to-blue-800 text-white rounded-xl hover:scale-105 transition-all"
                >
              ...
              {/* Marketing Dashboard */}
              <div className="animate-scaleIn delay-200 opacity-0 hidden lg:block">
                <div className="glass rounded-2xl p-6 sm:p-10 border border-border/50">
