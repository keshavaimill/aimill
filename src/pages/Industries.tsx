                ...
                >
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 bg-white/5 border border-white/10 shadow-[0_0_15px_-5px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_25px_-5px] transition-all duration-300 ${idx === 0 ? "group-hover:shadow-cyan/30 group-hover:border-cyan/30" :
                      idx === 1 ? "group-hover:shadow-purple/30 group-hover:border-purple/30" :
                        idx === 2 ? "group-hover:shadow-green/30 group-hover:border-green/30" :
                          idx === 3 ? "group-hover:shadow-pink/30 group-hover:border-pink/30" :
                            idx === 4 ? "group-hover:shadow-red-500/30 group-hover:border-red-500/30" :
                              "group-hover:shadow-teal/30 group-hover:border-teal/30"
                    }`}>
                    <industry.icon className={`w-7 h-7 stroke-[1.5] ${idx === 0 ? "text-cyan" :
                        idx === 1 ? "text-purple" :
                          idx === 2 ? "text-green" :
                            idx === 3 ? "text-pink" :
                              idx === 4 ? "text-red-400" :
                    ...
                    <ul className="space-y-2">
                      {industry.useCases.map((useCase, i) => (
                        <li key={i} className="text-sm flex items-center gap-2">
                          <span className={`w-1.5 h-1.5 rounded-full ${idx === 0 ? "bg-cyan" :
                              idx === 1 ? "bg-purple" :
                                idx === 2 ? "bg-green" :
                                  idx === 3 ? "bg-pink" :
                                    idx === 4 ? "bg-red-400" :
