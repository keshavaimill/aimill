  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {whyAIMill.map((item, idx) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: idx * 0.1 }}
                  className="group bg-white rounded-2xl p-12 shadow-md border border-gray-200 hover:translate-y-[-8px] hover:shadow-xl hover:border-blue-500 transition-all duration-300 cursor-pointer"
                >
        ...
        {/* CTA Section */}
        <section className="relative py-[120px] bg-gradient-to-r from-blue-500 via-blue-600 to-purple-500 overflow-hidden">
          {/* Background Effects */}
          ...
          <div className="container mx-auto max-w-4xl px-[80px] text-center relative z-10">
            ...
            >
              ...
              <p className="text-[22px] text-white/95 mb-12 max-w-[700px] mx-auto leading-relaxed">
                Join leading financial institutions already using AI Mill to transform lending operations.
              </p>
              <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
                <Button
                  size="lg"
                  className="bg-white text-blue-600 px-12 py-5 text-lg font-bold hover:bg-gray-100 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all rounded-xl"
                  asChild
                >
                  <Link to="/contact">
