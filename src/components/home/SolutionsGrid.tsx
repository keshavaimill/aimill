...
const solutions = [
  {
    icon: Target,
    title: "GrowthAI",
    description: "Agentic marketing automation that drives acquisition, engagement, and revenue.",
  ...
  },
  {
    icon: Scale,
    title: "LexAgent",
    description: "AI-driven legal workflows for faster reviews, approvals, and compliance.",
  ...
  },
  {
    icon: Users,
    title: "PeopleAgent",
    description: "AI assistant for HR operations, employee queries, and service delivery.",
  ...
  },
  {
    icon: Mail,
    title: "InboxAgent",
    description: "Agentic email intelligence for automated, accurate customer responses.",
  ...
  },
  {
    icon: TrendingUp,
    title: "ForecastML",
    description: "Machine-learning demand forecasts for smarter planning and inventory control.",
  ...
  },
  {
    icon: Shield,
    title: "ClaimAgent",
    description: "AI-enabled FNOL and claims intake with faster triage and resolution.",
  ...
  },
  {
    icon: Wrench,
    title: "MaintainAI",
    description: "Predictive maintenance intelligence to reduce downtime and asset failures.",
  ...
  },
  {
    icon: Target,
    title: "Agentic Labs",
    description: "End-to-end design, build, and deployment of enterprise AI agents.",
    href: "/consulting",
    color: "pink",
  },
];
